...
<table class="table table-bordered table-hover">
    ...
    <?php foreach ($produits as $produitData):
        ...
        <tr>
            ...
            <td style="background-color: <?php echo ($produit['produit_stock'] > 0) ? 'green' : 'red'; ?>;">
                <?php echo htmlspecialchars($produit['produit_stock']); ?>
            </td>
            ...
            <td>
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox"
                           id="highlanderProduct<?php echo $produitId; ?>" <?php echo $produit['produit_highlander'] ? 'checked' : ''; ?>
                           data-produit-id="<?php echo $produitId; ?>">
                    <label class="form-check-label" for="highlanderProduct<?php echo $produitId; ?>"></label>
                </div>
            </td>

            <td><a href="backoffice-prod-modif.php?id=<?php echo $produitId; ?>"
                   class="btn btn-warning btn-sm">Modifier</a></td>
            <td>
                <a href="#" class="btn btn-danger btn-sm"
                   onclick="confirmDeletion('<?php echo $produitId; ?>'); return false;">
                    Supprimer
                </a>
            </td>
        </tr>
