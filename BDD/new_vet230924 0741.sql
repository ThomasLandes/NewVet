...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 23 sep. 2024 à 07:40
...
--
CREATE DATABASE IF NOT EXISTS `new_vet` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `new_vet`;
...
(1, 'PANTALON', 'Découvrez notre collection de pantalons pour femmes, alliant confort, style et qualité. Du jean classique au chino élégant, trouvez le modèle parfait pour chaque occasion et affirmez votre style unique.', '..\\IMAGE\\Categorie\\Pantalon.jpg', 1),
...
(1, 'Jeans 60s', 'Jeans pattes d\'éléphant des années 60 : coupe évasée, style rétro emblématique pour un look vintage chic.', 59.99, 10, 1, 0, 1),
(2, 'Jeans Baggy', 'Jeans baggy : coupe ample, look décontracté et urbain, symbole des années 90.', 49.99, 13, 1, 0, 1),
...
(10, 'Haut Twill', 'Haut twill corset : coupe ajustée en tissu twill, combinant structure et élégance pour un look sophistiqué et féminin.', 29.99, 5, 1, 1, 3),
...
(15, 'Pull Standard', 'sweatshirt standard : classique et confortable, idéal pour un look décontracté avec une coupe simple et pratique.', 45.99, 18, 1, 4, 5),
...
INSERT INTO `utilisateur` (`utilisateur_id`, `utilisateur_email`, `utilisateur_mdp`, `utilisateur_nom`, `utilisateur_prenom`, `utilisateur_tel`, `utilisateur_token`, `utilisateur_is_valide`, `role_id`) VALUES
(28, 'thomas.landes@limayrac.fr', '$2y$10$UW758D6GEBcP.TayI24LHOHQL/vwS7jq/r46eCRILDfYBuA86g3yS', 'LANDES', 'Thomassss', '0781418965', '', 1, 2),
(29, 'tholanfc31@gmail.com', '$2y$10$tK.9cXFckAgA/MuwWTTMkOcwX43ISAR1xNCieif7kpbrPByw0cWOW', 'Wo', 'Thierry', '', '', 1, 1);
...
--
ALTER TABLE `paiement`
  MODIFY `paiement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `utilisateur`
  MODIFY `utilisateur_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
