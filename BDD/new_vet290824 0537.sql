...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 29 août 2024 à 05:36
...
(5, 'PULL', 'Explorez notre collection de pulls, alliant chaleur et style. Des modèles classiques aux designs tendance, trouvez le pull parfait pour chaque saison, idéal pour superposer ou porter seul.', '..\\IMAGE\\Categorie\\Pull.jpg', 0);
...
(1, 'Jeans 60s', 'Jeans pattes d\'éléphant des années 60 : coupe évasée, style rétro emblématique pour un look vintage chic.', 59.99, 10, 1, 1, 1),
...
(7, 'Robe Summer II', 'Robe Summer II : chic et fluide, parfaite pour les journées estivales, alliant confort et élégance avec des détails estivaux raffinés.', 39.99, 15, 1, 2, 2),
...
(10, 'Haut Twill', 'Haut twill corset : coupe ajustée en tissu twill, combinant structure et élégance pour un look sophistiqué et féminin.', 29.99, 5, 1, 3, 3),
...
(13, 'Pull Heavy', 'Pull heavy : épais et chaud, parfait pour se protéger du froid avec une touche de confort et de style robuste.', 79.99, 5, 1, 4, 5),
...
(15, 'Pull Standard', 'sweatshirt standard : classique et confortable, idéal pour un look décontracté avec une coupe simple et pratique.', 45.99, 18, 1, 5, 5),
...
(23, 'thomas.landes@limayrac.fr', '$2y$10$ctNlRW.YWw2B7zhu1DZizujUXMhOK8nBkPFOvEbEROJfojL2BUjlC', '', 1, 1);
...
--
ALTER TABLE `produit`
  MODIFY `produit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
